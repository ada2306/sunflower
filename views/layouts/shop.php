...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="/web/images/favicon.webp">
            ...
            <div class="row align-items-center">
                <div class="col-5 col-sm-6 col-lg-3">
                    <div class="header-logo">
                        <a href="/">
                            <img class="logo-main" src="/web/images/logo.webp" width="95" height="68" alt="Logo" />
                        </a>
                    </div>
                </div>
                <div class="col-lg-6 d-none d-lg-block">
                    <div class="header-navigation">
                        <ul class="main-nav justify-content-start">
                            ...
                            <li class="has-submenu position-static"><a href="web/site/shop">shop</a>
                        ...
                        <div class="widget-item">
                            <div class="widget-about">
                                <a class="widget-logo" href="index.html">
                                    <img src="/web/images/logo.webp" width="95" height="68" alt="Logo">
                                </a>
                ...
                <div class="modal-body">
                    <div class="product-action-view-content">
                        ...
                        <div class="modal-action-product">
                            <div class="thumb">
                                <img src="/web/images/shop/modal1.webp" alt="Organic Food Juice" width="466" height="320">
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="product-single-thumb">
                                        <img src="/web/images/shop/quick-view1.webp" width="544" height="560" alt="Image-HasTech">
                                    </div>
            ...
            <ul class="aside-cart-product-list">
                <li class="aside-product-list-item">
                    ...
                    <a href="product-details.html">
                        <img src="/web/images/shop/cart1.webp" width="68" height="84" alt="Image">
                ...
                <li class="aside-product-list-item">
                    <a href="#/" class="remove">×</a>
                    <a href="product-details.html">
                        <img src="/web/images/shop/cart2.webp" width="68" height="84" alt="Image">
