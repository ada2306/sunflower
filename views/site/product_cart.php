                    ...
                    <table class="table text-center">
                            ...
                            <td class="product-thumbnail">
                                <div class="thumb">
                                    <a href="single-product.html">
                                        <img src="/web/images/shop/cart1.webp" width="68" height="84" alt="Image-HasTech">
                                    </a>
                                </div>
                            </td>
                        ...
                        <tr class="tbody-item">
                            ...
                            <td class="product-thumbnail">
                                <div class="thumb">
                                    <a href="single-product.html">
                                        <img src="/web/images/shop/cart2.webp" width="68" height="84" alt="Image-HasTech">
                                    </a>
                                </div>
                            </td>
                            <td class="product-name">
                        ...
                        <tr class="tbody-item">
                            ...
                            <td class="product-thumbnail">
                                <div class="thumb">
                                    <a href="single-product.html">
                                        <img src="/web/images/shop/cart3.webp" width="68" height="84" alt="Image-HasTech">
                                    </a>
                                </div>
                            </td>
                            <td class="product-name">
